      ...
      <div class="feature">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><strong>Insert leave</strong></td><td>Creates an hourly leave. The proposed window covers the period not worked (gap) <strong>of the day</strong>, adjustable with the −/+ buttons in 15-minute steps. On <strong>split shifts</strong> the unpaid gaps between the blocks are excluded (see below).</td></tr>
