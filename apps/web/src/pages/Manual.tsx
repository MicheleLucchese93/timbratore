      ...
      <div class="feature">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><strong>Inserisci permesso</strong></td><td>Crea un permesso a ore. La finestra proposta copre il periodo non lavorato (gap) <strong>della giornata</strong>, modificabile con i pulsanti −/+ a passi di 15 minuti. Sugli <strong>orari spezzati</strong> vengono escluse le pause non retribuite fra le fasce (vedi sotto).</td></tr>
