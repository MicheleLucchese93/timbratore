...
const MAIN_IT = `
    ...
    <section class="chapter" id="accesso">
      ...
      <p class="lead">Stesse credenziali per Web e Mobile. L'amministratore crea il tuo account e ti invia un invito a impostare la password e accedere.</p>
      ...
      <div class="feature">
        ...
        <p class="muted">In alternativa, l'amministratore può reinviarti l'email di accesso dalla pagina <strong>Utenti</strong> (icona a forma di chiave sulla tua riga).</p>
      </div>
    ...
    <section class="chapter" id="web-admin-utenti">
      ...
      <div class="feature">
        ...
        <ul class="tidy">
          ...
          <li><strong>Invia email di accesso</strong> (icona a forma di chiave) — invia all'utente l'email per impostare/cambiare la password. Il tipo è automatico: <strong>invito</strong> se non ha ancora impostato la password (primo accesso a un utente appena creato), <strong>reset password</strong> se l'ha già fatto (credenziali smarrite / password dimenticata).</li>
      ...
      <div class="feature">
        ...
        <ul class="tidy">
          ...
          <li><strong>Invia email di accesso</strong> — invia a tutti i selezionati l'email di accesso (invito per chi non ha ancora impostato la password, reset per gli altri; comodo per il primo accesso di utenti appena creati).</li>
    ...
    <section class="chapter" id="web-admin-anomalie">
      ...
      <div class="feature">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><span class="pill pill-err">Uscita mancante</span></td><td>Nessuna timbratura uscita dopo che è passato l'orario di fine previsto. Durante il turno in corso (prima dell'orario di uscita) non è un'anomalia. Vale anche per le giornate rimaste con un <strong>ingresso aperto</strong> (uscita dimenticata, oppure timbrata dopo la mezzanotte e quindi registrata sul giorno successivo): l'uscita del pranzo non viene letta come uscita di fine giornata.</td></tr>
      ...
      <div class="feature">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><strong>Inserisci ferie</strong></td><td>Crea le ferie sul giorno dell'anomalia per conto del dipendente. Già approvate; le ore sono calcolate dall'orario assegnato. Copre l'<strong>intera giornata</strong>, non la singola anomalia.</td></tr>
            <tr><td><strong>Inserisci permesso</strong></td><td>Crea un permesso a ore. La finestra proposta copre il periodo non lavorato (gap) <strong>della giornata</strong>, modificabile con i pulsanti −/+ a passi di 15 minuti <strong>dentro le fasce</strong> dell'orario assegnato. Sugli <strong>orari spezzati</strong> vengono escluse le pause non retribuite fra le fasce (vedi sotto).</td></tr>
        ...
        <p><strong>Ferie e permesso valgono per la giornata, non per la singola riga.</strong> Uno stesso giorno può generare più anomalie: <em>Inserisci ferie</em> e <em>Inserisci permesso</em> compaiono su <strong>tutte</strong> le righe di quella giornata — comprese quelle di pausa. La finestra proposta per il permesso dipende invece dalla riga da cui apri la correzione:</p>
        <ul class="tidy">
          <li>sulle righe in cui è una <strong>timbratura reale</strong> a delimitare il buco — <em>Entrata in ritardo</em> (l'ingresso timbrato in ritardo) e <em>Uscita anticipata</em> (l'uscita timbrata in anticipo) — la finestra resta quella della riga e non cambia: con ingresso alle 10:30 su un orario 09:00–13:00 / 14:00–18:00, la riga <em>Entrata in ritardo</em> propone 09:00–10:30, cioè proprio le ore scoperte.</li>
          <li>su tutte le altre righe — <em>Entrata mancante</em>, <em>Uscita mancante</em>, <em>Ore giornaliere insufficienti</em>, pausa, uscita fuori area, giorno di riposo — la finestra viene ereditata dalla <strong>giornata</strong> ed è ricavata dall'insieme delle sue anomalie: il buco a inizio turno se c'è un'entrata in ritardo o mancante, il buco a fine turno se c'è un'uscita anticipata o mancante e, quando la giornata segnala solo <em>Ore giornaliere insufficienti</em>, le ore mancanti a fine turno. Il riepilogo dichiara sempre da quale anomalia arriva la finestra, così <em>"dalle 14:30 alle 17:00"</em> su una riga di pausa non viene letto come la durata della pausa.</li>
          <li><em>Ore giornaliere insufficienti</em> sta in questo secondo gruppo perché dice <strong>quante</strong> ore mancano, mai a quale estremo del turno mancano: su una giornata entrata in ritardo quella riga propone il buco di inizio turno e non le ultime ore del turno, che le timbrature dimostrano lavorate.</li>
          <li><em>Entrata mancante</em> e <em>Uscita mancante</em> stanno nello stesso gruppo perché il timbro che dovrebbe delimitare il buco è proprio quello che manca: da sole potrebbero solo indicare il turno intero. Con ingresso alle 10:30 e nessuna uscita timbrata, anche la riga <em>Uscita mancante</em> propone quindi 09:00–10:30 come la riga <em>Entrata in ritardo</em>, non l'intera giornata: il timbro assente si aggiunge con <em>Timbratura standard</em>, mentre il permesso copre solo le ore che le timbrature dimostrano scoperte.</li>
        </ul>
        <p>Esempio: ingresso 07:58 e uscita 14:38 su un orario 08:00–12:00 / 13:00–17:00 senza pausa pranzo timbrata. La giornata genera più anomalie, fra cui <em>Pausa pranzo troppo breve</em>: anche partendo da quella riga si arriva al permesso per le ore non lavorate della giornata, che sono quelle dopo l'uscita anticipata (14:30–17:00) e non la durata della pausa.</p>
        <p><strong>Giornate non lavorate a entrambi gli estremi.</strong> Quando lo stesso giorno ha un'entrata in ritardo <em>e</em> un'uscita anticipata, fra i due buchi ci sono <strong>ore lavorate</strong>: i periodi non lavorati sono due e distinti, un solo permesso non può coprirli, e sceglierne uno vorrebbe dire registrare l'altro come lavorato. Solo in questo caso il permesso non viene proposto a livello di giornata — né sulle righe che ereditano la finestra dalla giornata, comprese <em>Ore giornaliere insufficienti</em> e le righe di pausa, né nella barra di correzione in blocco — e va inserito con <strong>Correggi</strong> sulle due righe interessate (<em>Entrata in ritardo</em> e <em>Uscita anticipata</em>), una per periodo; l'app lo segnala e indica quante sono. <em>Inserisci ferie</em> resta invece disponibile, perché copre il turno intero e non dipende da dove sia il buco.</p>
        <p>Non basta però che la giornata sia segnalata a entrambi gli estremi: conta se le <strong>timbrature</strong> dimostrano una presenza in mezzo. Una giornata <strong>senza alcuna timbratura</strong> genera sia <em>Entrata mancante</em> sia <em>Uscita mancante</em>, ma il periodo non lavorato è <strong>uno solo</strong> — l'intero turno — e il permesso resta disponibile, anche in blocco. Allo stesso modo, se un solo estremo è ancorato da una timbratura reale, la finestra è quella metà: entrata alle 10:30 e uscita mai timbrata propone <em>09:00–10:30</em> (l'uscita si corregge con <em>Timbratura standard</em>), non l'intera giornata — e propone la stessa finestra da qualunque riga della giornata apri la correzione, comprese <em>Uscita mancante</em> e la barra di correzione in blocco.</p>
        <p><strong>Orari spezzati (due o più fasce).</strong> Su un orario come 08:00–12:00 / 13:00–17:00 la pausa fra le fasce <strong>non è tempo previsto</strong>: non è lavoro e non è assenza, e non va scalata dal residuo permessi. La finestra proposta viene quindi <strong>ritagliata sulle fasce</strong> e il permesso viene inserito <strong>una volta per fascia</strong>. Esempio: ingresso alle 09:00 e uscita alle 12:00 su un orario 09:00–13:00 / 14:00–18:00 propone <em>12:00–13:00</em> e <em>14:00–18:00</em>, cioè <strong>5 ore</strong> — le stesse che l'anomalia <em>Ore giornaliere insufficienti</em> dichiara mancanti — e non le 6 ore da 12:00 a 18:00. Il riepilogo elenca le fasce e la <em>Durata</em> mostra la loro somma; nelle <em>Richieste</em> del dipendente e nelle esportazioni compaiono quindi due righe di permesso per quella giornata. Vale allo stesso modo per la barra di correzione in blocco, che segnala prima della conferma quante giornate selezionate hanno un orario spezzato. Anche i due estremi della finestra vengono portati dentro le fasce: uscita alle 13:30 propone <em>14:00–18:00</em>, perché la mezz'ora dopo le 13:00 cade nella pausa non retribuita.</p>
        <p>Per lo stesso motivo i pulsanti <strong>−/+</strong> si muovono <strong>solo dentro le fasce</strong>: su 09:00–13:00 / 14:00–18:00 premendo <em>Dalle +</em> la finestra passa da 12:45 direttamente alle 14:00, saltando per intero la pausa non retribuita, e non può fermarsi alle 13:30 — un orario in cui non è previsto lavoro e che verrebbe comunque scartato al momento dell'inserimento. Agli estremi del turno i pulsanti si disattivano. Così <em>Dalle</em>, <em>Alle</em> e <em>Durata</em> descrivono sempre esattamente il permesso che verrà inserito.</p>
        <p>I permessi di una giornata con orario spezzato vengono inoltre inseriti in <strong>un'unica operazione</strong>: o entrano tutti o non ne entra nessuno, e il dipendente riceve <strong>una sola notifica</strong> per la giornata. Se l'inserimento viene rifiutato — per esempio perché le fasce insieme supererebbero le ore previste per quel giorno, magari per un permesso già presente — la giornata resta come prima, senza metà permesso da rimuovere a mano. In questo caso l'elenco delle anomalie viene ricaricato e la finestra proposta riparte dalla situazione reale della giornata, perché quella su cui avevi lavorato è stata calcolata su uno stato che il server ha appena smentito.</p>
        <p>Un rifiuto dice però anche <em>«un'altra operazione sulle assenze di questo dipendente è ancora in corso, riprova tra qualche istante»</em>: succede quando una correzione in blocco, o un altro amministratore, sta scrivendo sulle assenze della stessa persona. Lì non è stato scritto nulla e non è cambiato nulla, quindi la finestra che avevi impostato a mano <strong>resta esattamente com'è</strong> e <em>Conferma</em> ritenta la stessa cosa. Più in generale la finestra mostrata è sempre quella della giornata così com'è adesso: se l'elenco si ricarica per qualsiasi motivo — un'altra riga corretta, una correzione in blocco, il pulsante <em>Aggiorna</em> — e i timbri di quella giornata sono cambiati, il pannello aperto riparte dalla nuova proposta; se invece la giornata non è cambiata, le tue modifiche con i pulsanti −/+ restano dove le hai messe.</p>
        <p><strong>Quando ferie e permesso non compaiono.</strong> Se nella giornata <strong>non c'è tempo non lavorato</strong> resta disponibile la sola <strong>giustificazione con nota</strong>. È il caso dei giorni in cui l'unica anomalia riguarda la pausa (es. <em>Pausa troppo lunga</em>, <em>Pausa pranzo fuori finestra</em>) ma le ore sono state comunque completate: inserire una giornata intera di ferie su un giorno effettivamente lavorato falserebbe il cedolino. Lo stesso vale per <em>Lavoro in giorno di riposo</em> e <em>Uscita fuori area</em>, che non hanno un orario previsto da cui ricavare la finestra.</p>
        <p><strong>Minuti residui non copribili.</strong> Un permesso deve essere un multiplo di <strong>15 minuti</strong> e viene ritagliato sulle fasce: se il tempo non lavorato rimasto è più corto di un quarto d'ora — o non cade su un quarto d'ora — non esiste alcuna finestra da inserire, e <em>Inserisci ferie</em> e <em>Inserisci permesso</em> spariscono da <strong>tutte</strong> le righe di quella giornata. È una condizione della <strong>giornata</strong>, non della singola anomalia: il pannello <strong>Correggi</strong> la dichiara ed elenca i minuti rimasti scoperti su <strong>qualsiasi</strong> riga di quel giorno, comprese quelle di pausa e <em>Uscita fuori area</em>, che perdono le stesse due azioni per la stessa ragione. La barra di correzione in blocco conta quante giornate selezionate sono in questa condizione. Succede quando le fasce dell'orario non iniziano e non finiscono su un quarto d'ora: su un orario 09:00–13:20 / 14:00–17:40 una giornata di assenza copre 465 minuti sui 480 previsti e restano scoperti <em>13:15–13:20</em> e <em>17:30–17:40</em>, che continuano a generare <em>Entrata mancante</em> e <em>Uscita mancante</em>. Il pannello indica anche la via d'uscita che quella riga ha davvero: <em>Timbratura standard</em> dove manca un timbro, altrimenti — se i timbri ci sono già, come su una riga di pausa o su un'<em>Uscita anticipata</em> di pochi minuti — la sola <em>giustificazione con nota</em>. In ogni caso correggi gli orari delle fasce in <strong>Orari di lavoro</strong> per non ritrovarti quei minuti ogni giorno.</p>
        <p>Sulle righe che raggiungono ferie e permesso solo attraverso la giornata (pausa, uscita fuori area, giorno di riposo) il menù si apre comunque su <em>Giustifica con nota</em>: le assenze restano una scelta esplicita, mai la voce preselezionata. Vale anche per la <strong>barra di correzione in blocco</strong>: se la selezione è fatta solo di righe di questo tipo — per esempio cinque <em>Pausa pranzo troppo breve</em> — la barra si apre su <em>Giustifica con nota</em> e non su <em>Inserisci ferie</em>.</p>
      ...
      <div class="feature">
        ...
        <ul class="tidy">
          <li><em>Giustifica con nota</em> e <em>Timbratura standard</em> compaiono <strong>solo se valide per tutte</strong> le anomalie selezionate (l'intersezione): la nota è sempre disponibile, la timbratura standard solo se a tutte manca un timbro.</li>
          <li><em>Inserisci ferie</em> e <em>Inserisci permesso</em> sono correzioni di <strong>giornata</strong> e seguono una regola diversa: compaiono se <strong>almeno una</strong> delle giornate selezionate può riceverle, e le giornate che non possono vengono <strong>saltate</strong>. La barra dice prima della conferma quante ne salta e su quante applica la correzione. Una sola giornata senza tempo non lavorato — o non lavorata a entrambi gli estremi, che il permesso non può coprire — non fa quindi più sparire l'azione per tutte le altre: prima bastava un martedì di assenza in un mese selezionato per perdere <em>Inserisci permesso</em> su tutti gli altri giorni. Le giornate saltate vanno corrette a parte, dalle loro righe, o giustificate con nota.</li>
          ...
          <li>L'<em>Inserisci permesso</em> è disponibile <strong>anche in blocco</strong>: la finestra oraria non è condivisa ma calcolata <strong>per ogni giornata</strong> dal periodo non lavorato (gap), quindi ogni giorno riceve il proprio orario. Per ritoccarla a mano usa la correzione della <strong>singola riga</strong>, dove restano i pulsanti −/+ a passi di 15 minuti. Sulle giornate con <strong>orario spezzato</strong> viene inserito un permesso per fascia, escludendo la pausa non retribuita: la barra dice quante sono prima della conferma, e ogni giornata viene inserita in un'unica operazione (tutte le sue fasce o nessuna), quindi una giornata rifiutata resta intatta e compare nell'elenco delle non riuscite.</li>
          <li><strong>Conferma esplicita per le ferie in blocco.</strong> <em>Inserisci ferie</em> è l'unica azione della barra che consuma un residuo e manda una notifica per ogni giornata, quindi va spuntata una casella che dichiara <strong>quante giornate intere</strong> stai inserendo. Il pulsante <em>Correggi</em> resta disabilitato finché non la spunti, e la spunta si azzera se cambi azione o selezione.</li>
    ...
    <section class="chapter" id="web-admin-ferie">
      ...
      <div class="callout callout-warn">
        Le richieste di <strong>malattia</strong> sono auto-approvate al momento della creazione e richiedono obbligatoriamente il protocollo INPS. Una malattia che copre <em>tutti</em> i giorni di una ferie già approvata fa apparire sulla ferie il badge "Sostituita da malattia". Se ne copre solo una parte, la ferie viene accorciata ai giorni rimasti; se la malattia cade <em>dentro</em> il periodo di ferie, la ferie viene divisa in due richieste — i giorni prima e i giorni dopo la malattia — entrambe con lo stesso approvatore e, di norma, con lo stesso stato dell'originale. Unica eccezione: se sulla ferie era in corso una <strong>richiesta di revoca</strong>, la revoca resta sulla richiesta su cui è stata chiesta e i giorni dopo la malattia tornano <em>approvati</em>, così il dipendente può eventualmente chiederne la revoca a parte. Le ore di ferie non coperte dal certificato restano quindi al dipendente.
      </div>
    ...
    <section class="chapter" id="web-admin-assistenza">
      ...
      <div class="feature">
        ...
        <p>Quando una richiesta è chiusa — da te o dall'assistenza — la riga mostra <strong>solo l'esito</strong> («Risolta da te», «Chiusa») e non l'ultimo stato di lavorazione: una richiesta chiusa mentre era «in attesa di una tua risposta» continuerebbe altrimenti a chiederti una risposta che non serve più.</p>
        <p>Il pulsante <strong>Storico</strong>, dentro la scheda della richiesta, apre l'elenco di tutti i passaggi di stato con data e ora: quando è stata aperta, quando è stata presa in carico, quando è passata in attesa di una tua risposta, quando è stata risolta o chiusa. È registrato dal sistema a ogni cambio, quindi è completo anche per i passaggi fatti dalla console.</p>
    ...
    <section class="chapter" id="mob-user-richieste">
      ...
      <div class="feature">
        <h3>Tab "Calendario"</h3>
        <p>Vista calendario delle assenze con selettore <strong>Giorno / Settimana / Mese / Anno</strong>. I giorni con assenze mostrano puntini colorati per tipo e le <strong>festività nazionali</strong> sono evidenziate. Nelle viste <strong>Giorno</strong> e <strong>Settimana</strong> i permessi e le ferie <em>a ore</em> mostrano la fascia oraria (es. <em>09:00–11:00</em>). Il dipendente vede le proprie assenze; l'amministratore vede tutti, con i chip in alto per filtrare per dipendente.</p>
      </div>
    ...
    <section class="chapter" id="cantieri">
      ...
      <div class="feature">
        ...
        <ul class="tidy">
          <li><strong>Admin Cantieri</strong>: vede la voce <strong>Cantieri</strong> nel menu web e, al suo interno, le schede <strong>Dashboard</strong>, <strong>Cantieri</strong>, <strong>Campi personalizzati</strong> e <strong>Mezzi</strong>; gestisce l'intero modulo.</li>
      ...
      <div class="feature">
        <h3>Cantieri</h3>
        <p>Dalla voce <strong>Cantieri</strong> crei i cantieri con <strong>nome</strong>, <strong>indirizzo</strong> e <strong>stato</strong> (<span class="pill pill-ok">Aperto</span> o Chiuso: le attività si registrano solo sui cantieri aperti) e assegni gli <strong>addetti</strong>: solo gli assegnati vedono il cantiere nell'app.</p>
      </div>

      <div class="feature">
        <h3>Campi personalizzati</h3>
        <p>Dalla scheda <strong>Campi personalizzati</strong> aggiungi campi extra al modulo di registrazione attività — testo, numero, data, ora, sì/no o scelta da elenco, anche obbligatori. Per ogni campo puoi indicare i <strong>cantieri</strong> in cui mostrarlo: se non selezioni nessun cantiere il campo vale per <strong>tutti</strong>, altrimenti compare solo sui cantieri scelti (e nel relativo report). I campi dei mezzi restano nella scheda Mezzi.</p>
      </div>
      ...
      <div class="feature">
        ...
        <p>La <strong>Dashboard cantieri</strong> mostra una scheda per ogni cantiere con numero di attività, addetti coinvolti e totali di viaggio e attività. In alto filtri per <strong>cantiere</strong> e scegli il periodo: <strong>per giorno</strong>, <strong>per mese</strong> o <strong>tutto il periodo</strong>. La casella <strong>Solo con attività</strong> nasconde i cantieri che nel periodo selezionato non hanno registrazioni: con molti cantieri è il modo rapido per vedere, in un certo giorno, solo quelli che hanno avuto movimenti (il filtro per cantiere si restringe di conseguenza). Nelle due modalità a periodo le frecce ‹ › spostano di un giorno o di un mese, mentre i controlli al centro permettono di saltare direttamente a un periodo preciso: il <strong>calendario</strong> in modalità per giorno, i menu <strong>mese</strong> e <strong>anno</strong> in modalità per mese; <strong>Oggi</strong> e <strong>Mese corrente</strong> riportano al periodo in corso. Aprendo una scheda vedi il dettaglio delle registrazioni del periodo scelto. Da ogni scheda, con le icone dedicate, puoi <strong>scaricare il PDF</strong> del report mensile o <strong>inviarlo via email</strong> (il report è sempre mensile, quindi le azioni report compaiono solo in modalità «per mese»). Nell'invio indichi i <strong>destinatari</strong> e, se vuoi, gli indirizzi in <strong>CC</strong> e <strong>CCN</strong> e una <strong>nota</strong> formattata che compare nel corpo del messaggio; il PDF resta in allegato.</p>
      </div>
    ...
    <section class="chapter" id="cantieri-mobile">
      ...
      <p class="lead">Chi ha un ruolo Cantieri trova nell'app la scheda <strong>Cantieri</strong> con l'elenco delle proprie attività e un pulsante per aggiungerne di nuove.</p>

      <div class="feature">
        <h3>Le mie attività</h3>
        <p>La scheda <strong>Cantieri</strong> elenca le tue registrazioni, raggruppate per giorno. In alto filtri per <strong>cantiere</strong> e scegli il periodo: toccando il secondo chip passi da <strong>Mese</strong> a <strong>Giorno</strong> e poi a <strong>Tutto</strong> (tutte le attività). Nelle modalità Mese e Giorno le frecce spostano il periodo di uno, e toccando l'<strong>etichetta</strong> al centro scegli direttamente il giorno (calendario) o il mese (selettore mese/anno). Toccando un'attività la <strong>modifichi</strong>; con il cestino la <strong>elimini</strong>. Il pulsante <strong>+</strong> in basso a destra apre il modulo per registrarne una nuova.</p>
      </div>

      <div class="feature">
        <h3>Registrare un'attività</h3>
        <p>Dal pulsante <strong>+</strong> scegli il <strong>cantiere</strong> (solo quelli aperti a cui sei assegnato), la <strong>data</strong> e compili:</p>
        <ul class="tidy">
    ...
    <section class="chapter" id="faq">
      ...
      <div class="feature">
        ...
        <p>Dall'app mobile → scheda <strong>Richieste</strong> → <strong>+</strong> → seleziona <strong>Malattia</strong>. Inserisci il protocollo INPS e le date. La richiesta è auto-approvata e copre eventuali ferie sovrapposte: i giorni di ferie che il certificato non copre restano tuoi e continuano a comparire fra le tue richieste, se necessario divisi in due periodi (prima e dopo la malattia).</p>
      </div>
