// Inline SVG icon set for the partner console. Stroke-based, 18×18, inherits
// currentColor — sized for the 32px .icon-btn. Lucide-style geometry, no dep.
...
// Cantieri module glyph — Ionicons `construct-outline`, the same icon the web
// sidebar / mobile tab / marketing site use for the module. Its native 512
// viewBox + 32px stroke are overridden onto the 18×18 wrapper so it matches.
export const IconConstruct = () => (
  <Svg viewBox="0 0 512 512" strokeWidth={32}>
    <path
